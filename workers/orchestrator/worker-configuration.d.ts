/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 61234b711f63db1f12709462b0d2b77b)
...
interface __BaseEnv_Env {
	...
	TENANT_KEY: string;
	WOO_SOLUTION_PEPTIDES_BASE_URL: string;
	WOO_ATOMIK_LABZ_BASE_URL: string;
	CF_ACCESS_TEAM_DOMAIN: string;
	CF_ACCESS_AUD: string;
	PHONE_CACHE_HMAC_KEY: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BACKEND_AUTH_TOKEN" | "TENANT_KEY" | "WOO_SOLUTION_PEPTIDES_BASE_URL" | "WOO_ATOMIK_LABZ_BASE_URL" | "CF_ACCESS_TEAM_DOMAIN" | "CF_ACCESS_AUD" | "PHONE_CACHE_HMAC_KEY">> {}
}
